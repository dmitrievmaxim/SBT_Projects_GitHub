...
namespace GetDataFromJIRAPlugins
{
    class SQL_Worker
    {
        ...
        public static string _createTable_TempoLabor = @"BEGIN EXECUTE IMMEDIATE 'CREATE TABLE " + TempoTables.TempoLabor + @"(ID NUMBER(10) NOT NULL, ID_timesheet NUMBER(10) NOT NULL, ID_issue NUMBER(10) NOT NULL, Issue_name varchar(30) NOT NULL, Summary varchar(1000) NOT NULL, Timespent FLOAT NOT NULL, Workdate DATE NOT NULL, Full_name varchar(200) NOT NULL, User_name varchar(100) NOT NULL, Issue_type varchar(100) NOT NULL, ID_project NUMBER(10) NOT NULL, Description varchar(4000) NULL, Work_type_val varchar(1000) NULL, As_num varchar(1000) NULL, As_val varchar(1000) NULL, CONSTRAINT ID_timesheet_pk PRIMARY KEY(ID_timesheet))'; END;";
