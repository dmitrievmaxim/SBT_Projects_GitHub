...
namespace HPSM_email
{
    class SQL_Worker
    {
        ...
        public static string _insert_HPSMLabor = @"BEGIN EXECUTE IMMEDIATE 'INSERT INTO " + HPSMTables.HPSMLabor + @" VALUES ({0},''{1}'', TO_DATE(''{2}'', ''DD.MM.YYYY''), ROUND({3}/3600, 2),''{4}'', ''{5}'')'; END;";
